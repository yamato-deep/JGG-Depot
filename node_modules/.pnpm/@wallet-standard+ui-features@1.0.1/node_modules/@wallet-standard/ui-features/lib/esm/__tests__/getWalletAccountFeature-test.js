import { WALLET_STANDARD_ERROR__FEATURES__WALLET_ACCOUNT_FEATURE_UNIMPLEMENTED, WalletStandardError, } from '@wallet-standard/errors';
...
describe('getWalletAccountFeature', () => {
    ...
    it('throws if the account does not support the feature requested', () => {
        ...
        }).toThrow(new WalletStandardError(WALLET_STANDARD_ERROR__FEATURES__WALLET_ACCOUNT_FEATURE_UNIMPLEMENTED, {
            address: 'abc',
