...
declare const DEFAULT_SECP256R1_DERIVATION_PATH = "m/74'/784'/0'/0/0";
/**
 * Secp256r1 Keypair data
 */
interface Secp256r1KeypairData {
 ...
 */
declare class Secp256r1Keypair extends Keypair {
  private keypair;
  /**
...
//#endregion
export { DEFAULT_SECP256R1_DERIVATION_PATH, Secp256r1Keypair, Secp256r1KeypairData };
