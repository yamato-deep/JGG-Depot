import { getOrCreateUiWalletAccountForStandardWalletAccount_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, getOrCreateUiWalletForStandardWallet_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, } from '@wallet-standard/ui-registry';
...
describe('uiWalletAccountsAreSame()', () => {
    ...
    beforeEach(() => {
        ...
        mockUiWalletAccount = getOrCreateUiWalletAccountForStandardWalletAccount_DO_NOT_USE_OR_YOU_WILL_BE_FIRED(mockWallet, mockWalletAccount);
    });
    ...
    it('returns true if the addresses and underlying `Wallet` match, despite the objects being different', () => {
        const clonedMockUiWalletAccount = getOrCreateUiWalletAccountForStandardWalletAccount_DO_NOT_USE_OR_YOU_WILL_BE_FIRED(mockWallet, {
            ...mockWalletAccount,
    ...
    it('returns false if the addresses match but the underlying `Wallet` does not', () => {
        const clonedMockUiWalletAccount = getOrCreateUiWalletAccountForStandardWalletAccount_DO_NOT_USE_OR_YOU_WILL_BE_FIRED({ ...mockWallet }, mockWalletAccount);
...
describe('uiWalletAccountBelongsToUiWallet()', () => {
    ...
    it('returns false if the UI wallet account does not belong to the UI wallet', () => {
        ...
        const identicalAccountInDifferentWallet = getOrCreateUiWalletAccountForStandardWalletAccount_DO_NOT_USE_OR_YOU_WILL_BE_FIRED(differentWallet, mockWalletAccount);
